          ...
          <?php } ?>
            ...
            <div class="container justify-content-center ">
                 <div class="container-sm bg-body-secondary  rounded-1 border" style="background-color: var(--bs-tertiary-bg);"><br>
                    <h5 class=" text-center ">Actualizar Datos de Usuarios Registrados</h5> <br>
                 </div>
                  ...
                  <tbody class="table-group-divider">
                      ...
                      <tr>
                        ...
                        <td><?php echo $dato['email']; ?></td>                      
                          <td><a class="btn btn-success" href="<?= base_url('/edit/'.$dato['id_usuario'])?>">Editar</a>
                            <!--<a class="btn btn-primary" href="< ?= base_url('/delete/'.$dato['id_usuario'])?>">Delete</a>--></td>   
                      </tr>
                      <?php endforeach; ?>  
                    </tbody>
              </table>
