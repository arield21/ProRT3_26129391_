            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <h5 class="mb-3"><a href="#!" class="text-body"><i
                      class="fas fa-long-arrow-alt-left me-2"></i>Continuar con la compra</a></h5>
                <hr>

                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div>
                    <p class="mb-1">Menu Compras</p>
                    <p class="mb-0">Usted tiene Seleccionado 4 Productos</p>
                  </div>
                  <div>
                    <p class="mb-0"><span class="text-muted">Filtrar por:</span> <a href="#!"
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <div class="d-flex flex-row align-items-center">
                        <div>
                          <img
                            src="assets/icons/bootstrap1.svg"
              ...
              <div class="col-lg-5">
                ...
                <div class="card bg-primary text-white rounded-3">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                      <h5 class="mb-0">informacion de la tarjeta</h5>
                      <img src="assets/img/fotodos.jpg"
