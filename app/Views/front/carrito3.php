<section class="h-100 bg-secondary-subtle">
  <div class="container h-100 py-5">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-10">

        <div class="d-flex justify-content-between align-items-center mb-4">
          <h3 class="fw-normal mb-0">Ingresar Producto Nuevo</h3>
          <div>
            <p class="mb-0"><span class="text-muted">Filtrar:</span> <a href="#!" class="text-body">Precio <i
