          ...
          <a class="navbar-brand col-lg-3 me-0" href="#">  </a>        
               <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                      ...
                      <li class="nav-item dropdown pe-sm-1 ">              
                              <a class="nav-link dropdown-toggle btn btn-dark text-light" href="#" data-bs-toggle="dropdown" aria-expanded="false">Menu Productos</a>                              
                                  <ul class="dropdown-menu bg-body-secondary">
                                    <li><a class="dropdown-item bg-body-secondary" href="<?php echo base_url('/carrito_cliente');?>">Productos</a></li>
                                    <li><a class="dropdown-item" href="<?php echo base_url('/carrito3');?>">Ingresar Productos</a></li>
                                    <li><a class="dropdown-item bg-body-secondary" href="<?php echo base_url('/carrito2');?>">Editar Productos</a></li>
                                    <li><a class="dropdown-item" href="<?php echo base_url('/carrito4');?>" >Editar/Eliminar Productos</a></li>
                                    <li><a class="nav-link text-dark bg-body-secondary" href="<?php echo base_url('/logout');?>" tabindex="-1" aria-disabled="true">Cerrar Sesión</a></li>       
                                  </ul>
                      </li>
                      <li class="nav-item dropdown pe-sm-1">              
                              <a class="nav-link dropdown-toggle btn btn-dark text-light" href="#" data-bs-toggle="dropdown" aria-expanded="false">Menu Admin</a>
                                  ...
                                  <ul class="dropdown-menu bg-body-secondary">
                                    <li><a class="dropdown-item" href="<?php echo base_url('/listado1');?>">Listado Usuarios</a></li>
                                    <li><a class="dropdown-item" href="<?php echo base_url('/actuali');?>">Editar Usuario</a></li>
                                    <li><a class="dropdown-item" href="<?php echo base_url('/elim');?>">Eliminar Usuario</a></li>
                                    <li><a class="dropdown-item" href="<?php echo base_url('/add');?>">Ingresar Usuario</a></li> 
                                    <li><a class="dropdown-item" href="<?php echo base_url('/listado');?>">admin usuarios</a></li>   
                      ...
                      <li class="nav-item d-lg-flex col-lg-4  ms-lg-1 ">             
                          <form role="search" >
                            <input class="form-control" type="search" name="buscar" placeholder="buscar" aria-label="sdfSearch">
                          </form>
                      </li>
                      <li class="nav-item">
            ...
            <a class="navbar-brand col-lg-3 me-0" href="#">  </a>        
               <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                     ...
                     <li class="nav-item ">
                      ...
                      <li class="nav-item">
                            <a class="nav-link btn btn-dark text-light" href="<?php echo base_url('carrito');?>">promociones</a>
                      </li>           
                      <li class="nav-item dropdown pe-sm-1">              
                        <a class="nav-link dropdown-toggle btn btn-dark text-light" href="#" data-bs-toggle="dropdown" aria-expanded="false">Menu de Usuario</a>
                          <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="<?php echo base_url('carrito2');?>">Servicio Usuario 2 </a></li>
                              <li><a class="dropdown-item" href="<?php echo base_url('carrito3');?>">Servicio Usuario 3 </a></li>
                              <li><a class="nav-link text-dark" href="<?php echo base_url('/logout');?>" tabindex="-1" aria-disabled="true">Cerrar Sesión</a></li>
                          </ul>
                      </li>
                      <li class="nav-item d-lg-flex col-lg-4  ms-lg-1 ">             
        ...
        <div class="collapse navbar-collapse d-lg-flex mt-sm-3 mb-sm-3" id="navbarsExample11" >
            ...
            <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                  ...
                  <li class="nav-item dropdown pe-sm-1">              
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="<?php echo base_url('carrito_cliente');?>">Productos</a></li>
                      <li><a class="dropdown-item" href="<?php echo base_url('carrito_cliente');?>">Productos 2</a></li>
                      <li><a class="dropdown-item" href="<?php echo base_url('carrito_cliente');?>">Productos 3</a></li> 
